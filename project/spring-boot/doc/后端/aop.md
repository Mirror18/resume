...
### [什么是 IoC?](https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html#什么是-ioc)
...
### [IoC 解决了什么问题?](https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html#ioc-解决了什么问题)
...
![img](https://cdn.jsdelivr.net/gh/Mirror18/imgage@img/note/202405042314027.png)
...
### [IoC 和 DI 有区别吗？](https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html#ioc-和-di-有区别吗)
...
老马（Martin Fowler）在一篇文章中提到将 IoC 改名为 DI，原文如下，原文地址：[https://martinfowler.com/articles/injection.htmlopen in new window](https://martinfowler.com/articles/injection.html) 。

![img](https://cdn.jsdelivr.net/gh/Mirror18/imgage@img/note/202405042314195.png)
...
### [什么是 AOP？](https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html#什么是-aop)
...
### [AOP 为什么叫面向切面编程？](https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html#aop-为什么叫面向切面编程)
...
### [AOP 解决了什么问题？](https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html#aop-解决了什么问题)
...
![img](https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/crosscut-logic-and-businesslogic-separation      .png)
...
### [AOP 的应用场景有哪些？](https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html#aop-的应用场景有哪些)
...
### [AOP 实现方式有哪些？](https://javaguide.cn/system-design/framework/spring/ioc-and-aop.html#aop-实现方式有哪些)

AOP 的常见实现方式有动态代理、字节码操作等方式。

Spring AOP 就是基于动态代理的，如果要代理的对象，实现了某个接口，那么 Spring AOP 会使用 **JDK Proxy**，去创建代理对象，而对于没有实现接口的对象，就无法使用 JDK Proxy 去进行代理了，这时候 Spring AOP 会使用 **Cglib** 生成一个被代理对象的子类来作为代理，如下图所示：

![SpringAOPProcess](https://cdn.jsdelivr.net/gh/Mirror18/imgage@img/note/202405042314049.jpeg)SpringAOPProcess
