...
![image-20240509042044051](https://cdn.jsdelivr.net/gh/Mirror18/imgage@img/note/202405090420128.png)
...
所以可以发现，操作起来还是很简单的，具体实现的话，也就在shopcontroller和dishcontroller中进行操作，主要是就这么点数据量，只能说是操作着玩了。
